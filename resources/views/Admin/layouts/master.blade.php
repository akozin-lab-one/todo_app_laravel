    ...
    <nav class="bg-white border-gray-200 dark:bg-gray-900 sticky top-0 border border-b-8 ">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div class="flex items-center md:order-2">
                <button type="button"
                    class="flex mr-2 text-sm bg-gray-800 rounded-full md:mr-0 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-600"
                ...
                <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600"
                    ...
                    <ul class="py-2" aria-labelledby="user-menu-button">
                        <li>
                            <a href="{{route('admin.account', Auth::user()->id)}}"
